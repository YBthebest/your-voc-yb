...
$listeTitre = array(
	"accueil" => "Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.",
	"afficher" => $titleAfficher,
	"profs" => "Pour les profs - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc",
);
...
function getTitleAfficher(){
	...
	return $titre." - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
}

$url = "";
function initTitle($url){
	if (preg_match("/index.php/i", $url)) {
		$_ENV['title'] = $url." Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
	...
	elseif (preg_match("/profs.php/i", $url)) {
		$_ENV['title'] = "Pour les profs - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc";
	...
	elseif (preg_match("/all.php/i", $url)) {
		$_ENV['title'] = "Toutes les listes - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
		$_ENV['metaContent'] = "Vous trouverez ici toutes les listes disponibles sur Your-Voc.";
	}
	elseif (preg_match("/categories.php/i", $url)) {
		$_ENV['title'] = "Les Catégories - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
		$_ENV['metaContent'] = "Voici la liste des catégories présentes sur Your-Voc.";
	}
	elseif (preg_match("/ccm.php/i", $url)) {
		$_ENV['title'] = "Comment ça marche? - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
		$_ENV['metaContent'] = "Comment marche Your-Voc? La réponse sur cette page.";
	}
	elseif (preg_match("/connexion/i", $url)) {
		$_ENV['title'] = "Connexion - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
	...
	elseif (preg_match("/inscription.php/i", $url)) {
		$_ENV['title'] = "Inscription - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
		$_ENV['metaContent'] = "Inscrivez-vous à Your-Voc.";
	}
	elseif (preg_match("/membre.php/i", $url)) {
		$_ENV['title'] = "Espace Membre - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
		$_ENV['metaContent'] = "L'espace membre de Your-Voc.";
	}
	elseif (preg_match("/recherche.php/i", $url)) {
		$_ENV['title'] = "Faire une recherche - Révision de vocabulaire allemand anglais espagnol facilement sur Your-Voc.";
